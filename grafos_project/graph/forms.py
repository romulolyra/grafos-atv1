...
class GraphInputForm(forms.Form):
	...
	# Opções de 1 vertice
	operator_vertex = forms.CharField(label='Vertice :', max_length=50, inititial = '', required = False)
	operation_one = forms.CharField(label='Operação1 :', max_length=50, required = False)


	# two vertices operations
	operation_two = forms.CharField(label='Operação2 :', max_length=50,inititial = '', required = False)
	origin_vertex = forms.CharField(label='Vertice 1 :', max_length=50,inititial = '', required = False)
