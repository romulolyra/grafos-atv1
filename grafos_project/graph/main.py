...
def calculate(file_name, is_directed, is_valorado):
	with open(file_name) as file:
		...
		if is_directed:
			graph_lib = generate_directed(file_name)
			print("Grau direcionado :", degree_dir)
		else:
			graph_lib = generate_undirected(file_name)
			print("Grau nao direcionado", degree_not_dir)

		if is_valorado:
			#saber o source e destiny que vem do usuario
			#best_way_between_two_nodes(graph_lib, source, destiny)
